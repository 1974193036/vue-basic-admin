<template>
  <div class="app-container">
    ...
    <div :key="key" style="margin-top: 30px">
      ...
      <div>
        <el-button type="primary" v-permission="['editor']">新增</el-button>
        <el-button type="warning" v-permission="['editor']">修改</el-button>
        <el-button type="danger" v-permission="['editor']">删除</el-button>
      </div>
